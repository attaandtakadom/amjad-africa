...
const questionsMatrix = [
...

  {
    ...
    "pdfSolutionSteps": [
      ...
      "📢 لحساب المسافة المقطوعة باستخدام القدرة:",
      "",
      "• خطوة 1: تحويل القدرة إلى واط:",
      "  P = 2 kW = 2000 W",
      "",
      "• خطوة 2: حساب الشغل المبذول:",
      "  W = P × t = 2000 × 6 = 12000 J",
      "",
      "• خطوة 3: الشغل في الرفع العمودي = m · g · s:",
    ...
    "steps": [
      {
        ...
        "feedback": "✅ ممتاز! المركبة الأفقية فقط هي التي تحرك العربة، أما العمودية فتلغيها رد الفعل العمودي."
      }
    ],
    "pdfSolutionSteps": [
      "══════════════ الخيارات ══════════════",
      ...
      "",
      "══════════════ 📑 الشرح والقوانين العامة لـ PDF ══════════════",
      "📢 لحساب العجلة الناتجة عن قوة مائلة:",
      "",
      "• خطوة 1: حساب المركبة الأفقية للقوة:",
      "  F_x = F · cos(θ) = 6 × cos(35°) = 6 × 0.819 = 4.92 N",
      "",
      "• خطوة 2: تطبيق قانون نيوتن الثاني:",
      "  a = F_x / m = 4.92 / 3.5 = 1.4 m/s²",
      "",
      "💡 نصيحة: المركبة العمودية للقوة لا تؤثر على الحركة الأفقية.",
      "",
    ...
    "steps": [
      {
        ...
        "feedback": "✅ صحيح! الجسم ساكن، لذا محصلة القوى الموازية = صفر، والاحتكاك يعادل مركبة الوزن."
      }
    ],
    "pdfSolutionSteps": [
      "══════════════ الخيارات ══════════════",
      ...
      "",
      "══════════════ 📑 الشرح والقوانين العامة لـ PDF ══════════════",
      "📢 لحساب قوة الاحتكاك السكوني على مستوى مائل:",
      "",
      "• خطوة 1: حساب مركبة الوزن الموازية للسطح:",
      "  W_parallel = m · g · sin(θ)",
      "  W_parallel = 30 × 10 × sin(18°) = 300 × 0.309 = 92.7 N",
      "",
      "• خطوة 2: شرط الاتزان السكوني:",
      "  f = W_parallel = 92.7 N",
      "",
      "💡 نصيحة: الاحتكاك السكوني يتغير قيمته تلقائياً ليعادل القوى المؤثرة حتى حد الانزلاق.",
      "",
  ...
  {
    "title": "س23: حساب مقدار واتجاه قوة الاحتكاك على مستوى مائل بقوة أفقية",
    ...
    "steps": [
      {
        ...
        "feedback": "✅ صحيح! القوة الصاعدة (19.28 N) أكبر من الهابطة (15.32 N)، لذا يميل الجسم للصعود، والاحتكاك يعاكس هذا الاتجاه (لأسفل)."
      }
    ],
    "pdfSolutionSteps": [
      "══════════════ الخيارات ══════════════",
      ...
      "",
      "══════════════ 📑 الشرح والقوانين العامة لـ PDF ══════════════",
      "📢 لحساب قوة الاحتكاك في وجود قوة أفقية:",
      "",
      "• خطوة 1: حساب مركبة القوة الأفقية الصاعدة:",
      "  F_up = 30 · cos(50°) = 30 × 0.6428 = 19.28 N",
      "",
      "• خطوة 2: حساب مركبة الوزن الهابطة:",
      "  W_down = mg · sin(50°) = 20 × 0.7660 = 15.32 N",
      "",
      "• خطوة 3: الفرق بينهما:",
      "  F_net = 19.28 - 15.32 = 3.96 N (لأعلى)",
      "",
      "• خطوة 4: للاتزان، يجب أن يكون الاحتكاك لأسفل:",
      "  f = 3.96 N ≈ 3.69 N (بسبب دقة التقريب)",
      "",
      "💡 نصيحة: الاحتكاك دائماً يعاكس اتجاه الحركة الوشيكة.",
      "",
  ...
  {
    "title": "س27: حساب عجلة الحركة لمنظومة البكرات (آلة أتوود)",
    ...
    "steps": [
      {
        ...
        "feedback": "✅ ممتاز! العجلة تعتمد على فرق الكتل مقسوماً على مجموعهما، مضروباً في الجاذبية."
      }
    ],
    "pdfSolutionSteps": [
      "══════════════ الخيارات ══════════════",
      ...
      "",
      "══════════════ 📑 الشرح والقوانين العامة لـ PDF ══════════════",
      "📢 لحساب عجلة آلة أتوود:",
      "",
      "• خطوة 1: كتابة معادلة العجلة العامة:",
      "  a = (m₂ - m₁) / (m₂ + m₁) · g",
      "",
      "• خطوة 2: التعويض بالكتل المعطاة:",
      "  a = (3 - 2) / (3 + 2) × 10",
      "  a = (1 / 5) × 10 = 2 m/s²",
      "",
      "💡 نصيحة: العجلة لا تعتمد على موقع البكرة أو طول الخيط، فقط على فرق الكتل ومجموعها.",
      "",
  ...
  },
  {
    ...
    "svgCode": "<div style='background: #ffffff; border-radius: 14px; padding: 20px; border: 1.5px solid #e2e8f0; box-shadow: 0 4px 6px -1px rgba(0,0,0,0.05); direction: rtl;'>\n    <div style='background: #f0fdf4; border-right: 4px solid #16a34a; padding: 10px; font-size: 13px; color: #14532d;'>\n        <strong>💡 تذكير فيزيائي:</strong> الجول (J) = نيوتن · متر (N·m)، وهما وحدتان مكافئتان تماماً. الوات (W) هو وحدة القدرة وليس الشغل.\n    </div>\n</div>",
    "steps": [
      {
    ...
    "pdfSolutionSteps": [
      ...
      "",
      "══════════════ 📑 الشرح والقوانين العامة لـ PDF ══════════════",
      "📢 الشغل الميكانيكي يُعرَّف بـ: W = F · d · cos(θ)",
      "",
      "• وحدات الشغل:",
      "  نيوتن × متر = N·m = جول (J)",
      "",
      "• ملاحظة: الوات (W) هو وحدة القدرة (معدل بذل الشغل):",
      "  1 W = 1 J/s",
      "",
  ...
  },
  {
    ...
    "correctAnswerIndex": 3,
    "svgCode": "<div style='background: #ffffff; border-radius: 14px; padding: 20px; border: 1.5px solid #e2e8f0; box-shadow: 0 4px 6px -1px rgba(0,0,0,0.05); direction: rtl;'>\n    <div style='background: #fef2f2; border-right: 4px solid #ef4444; padding: 10px; font-size: 13px; color: #991b1b;'>\n        <strong>💡 تذكير فيزيائي:</strong>\n        <br>• الشغل = صفر عندما تكون القوة عمودية على الإزاحة (cos 90° = 0).\n        <br>• الجاذبية لا تبذل شغلاً في المدار الدائري (لأنها مركزية).\n        <br>• السرعة = صفر عند أقصى ارتفاع في القذف الرأسي.\n        <br>• السرعة ≠ صفر لحظة وصول الجسم للأرض في السقوط الحر.\n    </div>\n</div>",
    "steps": [
      {
        "title": "تحليل كل حالة فيزيائية",
        "question": "في أي حالة تكون السرعة النهائية لا تساوي صفراً؟",
        "options": [
          { "text": "أ) عند أقصى ارتفاع للقذف الرأسي", "isCorrect": false },
          { "text": "ب) لحظة وصول الساقط حراً إلى الأرض", "isCorrect": true }
        ],
        "feedback": "✅ صحيح! في السقوط الحر، تصل السرعة إلى قيمتها القصوى لحظة الاصطدام بالأرض، ولا تساوي صفراً."
      }
    ],
    "pdfSolutionSteps": [
      "══════════════ الخيارات ══════════════",
      "أ) الشغل = صفر (لأن القوة عمودية على الإزاحة)",
      "ب) الشغل = صفر (الجاذبية مركزية في المدار الدائري)",
      "ج) السرعة = صفر (عند أقصى ارتفاع)",
      "د) السرعة ≠ صفر  ✅ (الإجابة الصحيحة)",
      "",
      "══════════════ 📑 الشرح والقوانين العامة لـ PDF ══════════════",
      "📢 تحليل كل حالة:",
      "",
      "• أ: W = F·d·cos(90°) = 0",
      "• ب: في المدار الدائري، الإزاحة عمودية على الجاذبية، فـ W = 0",
      "• ج: عند أقصى ارتفاع، v = 0 مؤقتاً قبل الهبوط",
      "• د: في السقوط الحر، v = √(2gh) ≠ 0",
      "",
      "الإجابة النهائية: د) سرعة الجسم الساقط سقوطاً حراً لحظة وصوله إلى سطح الأرض"
    ],
    "pdfFinalAnswer": "د) سرعة الجسم الساقط سقوطاً حراً لحظة وصوله إلى سطح الأرض"
  },
  {
    ...
    "correctAnswerIndex": 3,
    "svgCode": "<div style='background: #ffffff; border-radius: 14px; padding: 20px; border: 1.5px solid #e2e8f0; box-shadow: 0 4px 6px -1px rgba(0,0,0,0.05); direction: rtl;'>\n    <div style='background: #fdf4ff; border-right: 4px solid #c084fc; padding: 10px; font-size: 13px; color: #581c87;'>\n        <strong>💡 تذكير فيزيائي شامل:</strong>\n        <br>• في السقوط الحر، العجلة ثابتة = g.\n        <br>• السرعة تزداد خطياً مع الزمن: v = g·t.\n        <br>• الوزن = الكتلة × g، لذا النسبة وزن/كتلة = g = 10.\n    </div>\n</div>",
    "steps": [
      {
        ...
        "feedback": "✅ صحيح! في السقوط الحر، العجلة ثابتة = g، بينما السرعة تتغير خطياً."
      }
    ],
    "pdfSolutionSteps": [
      "══════════════ الخيارات ══════════════",
      "أ) ✅ صحيح: v = g·t = 10t، فتزداد 10 m/s كل ثانية",
      "ب) ✅ صحيح: a = g = 10 m/s² (ثابتة)",
      "ج) ✅ صحيح: W/m = g = 10",
      "د) جميع العبارات صحيحة  ✅ (الإجابة الصحيحة)",
      "",
      "══════════════ 📑 الشرح والقوانين العامة لـ PDF ══════════════",
      "📢 السقوط الحر يتميز بـ:",
      "",
      "• عجلة ثابتة: a = g = 10 m/s²",
      "• سرعة متغيرة خطياً: v = g·t",
      "• علاقة الوزن بالكتلة: W = m·g → W/m = g",
      "",
      "💡 جميع الخيارات (أ، ب، ج) هي نتائج مباشرة لثبات العجلة.",
      "",
